...
image_shape = (512,512,3)#(384,384,3)
...
def train(epochs, batch_size, input_dir, output_dir, model_save_dir, number_of_images, train_test_ratio):
    ...
    x_train_lr, x_train_hr, x_test_lr, x_test_hr = Utils.load_training_data(input_dir, '.bmp', number_of_images, train_test_ratio) #这里应该是关于训练的参数修改
